...
//            retriever.Setup(x => x.GetJourneysForDates(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<DateTime>>()).Result).Returns(new JourneyCollection());
...
//        [TestMethod]
//        public async Task RunIsSuccesful_FilesProvidedAsync()
//        {
//            Parameters parameters = new();
//            parameters.Origins = new() { "LTN" };
//            parameters.Destinations = new() { "VAR" };
