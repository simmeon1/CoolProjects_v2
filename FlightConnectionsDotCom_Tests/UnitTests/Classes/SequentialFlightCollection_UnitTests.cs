...
namespace FlightConnectionsDotCom_Tests.UnitTests
{
    ...
    public class SequentialFlightCollection_UnitTests
    {
        ...
        private readonly Journey bus1 = new(new DateTime(2000, 11, 11, 07, 00, 00), new DateTime(2000, 11, 11, 13, 00, 00), "easyJet", new TimeSpan(4, 0, 0), "ABZ-EDI", 15, JourneyType.Local);
        ...
        private readonly Journey bus3 = new(new DateTime(2000, 11, 11, 18, 40, 00), new DateTime(2000, 11, 11, 21, 00, 00), "easyJet", new TimeSpan(4, 0, 0), "VAR-BOJ", 15, JourneyType.Local);
